...
-- WEEKLY SCHEDULES (Mon–Sun)  -- H2 wants HH:MM:SS
...
VALUES
  (1, 1, TIMESTAMP '2025-10-20 18:00:00', 4, 'CONFIRMED', 'AB7K2F', 'Window seat'),
  (2, 1, TIMESTAMP '2025-10-21 19:30:00', 2, 'PENDING',   'XZ4M9Q', NULL),
  (3, 2, TIMESTAMP '2025-10-22 17:45:00', 3, 'CONFIRMED', 'QR8Z7J', 'Birthday dinner'),
  (4, 3, TIMESTAMP '2025-10-23 18:15:00', 5, 'CONFIRMED', 'LM4T2P', NULL),
  (5, 1, TIMESTAMP '2025-10-24 19:00:00', 2, 'CANCELLED', 'JK9N8C', 'Allergic to nuts');